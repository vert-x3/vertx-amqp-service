...
public class AmqpServiceImpl2 extends ConnectionManager implements AmqpService
{
    private static final Logger _logger = LoggerFactory.getLogger(AmqpServiceImpl2.class);
    ...
    public AmqpServiceImpl2(Vertx vertx, JsonObject config)
    {
        super(vertx);
        _eb = vertx.eventBus();
    }
